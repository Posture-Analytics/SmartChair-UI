# this file generates the z layer for
# the contour plot. It is capable of
# plotting the sensor data according to
# the sensor's position on the chair.
from copy import deepcopy

# coordinates of sensor positions in the range [-1, 1]
coords = {'p00': (0.3, 0.35), 'p01': (-0.3, 0.35), 'p02': (0.3, -0.35), 'p03': (-0.3, -0.35),
...
points = {key: (round(coords[key][1] * scale_y + scale_y), round(coords[key][0] * scale_x + scale_x)) for key in coords.keys()}
...
def generate_z(data) -> list:
    ...
    -------
    z : list
        The z layer for the contour plot.
    """
    global z_base
...
if __name__ == "__main__":
    z = generate_z({'p00': 1, 'p01': 2, 'p02': 3, 'p03': 4, 'p04': 5, 'p05': 6, 'p06': 7, 'p07': 8, 'p08': 9, 'p09': 10, 'p10': 11, 'p11': 12})
    print(z)
